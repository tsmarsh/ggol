window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=3cbf5d&fwbuild=dev"};
...
document.write('<script>goog.require("folly.core");</script>');
