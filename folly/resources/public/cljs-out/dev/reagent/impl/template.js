...
var G__11766 = o;
goog.object.set(G__11766,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__11770 = o;
goog.object.set(G__11770,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__11771__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__11772__i < G__11772__a.length) {G__11772__a[G__11772__i] = arguments[G__11772__i + 0]; ++G__11772__i;}
  args = new cljs.core.IndexedSeq(G__11772__a,0,null);
} 
return G__11771__delegate.call(this,args);};
G__11771.cljs$lang$maxFixedArity = 0;
G__11771.cljs$lang$applyTo = (function (arglist__11773){
var args = cljs.core.seq(arglist__11773);
return G__11771__delegate(args);
});
...
var G__11774 = props;
var G__11774__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__11774,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11774);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11774__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__11774__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__11775 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11775,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__11775;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11776){
...
var on_write = cljs.core.get.call(null,map__11777__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__11779_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11779_SHARP_);
}));
} else {
return null;
}
...
var vec__11782 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11782,(0),null);
var id = cljs.core.nth.call(null,vec__11782,(1),null);
var className = cljs.core.nth.call(null,vec__11782,(2),null);
...
var temp__5724__auto___11786 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___11786 == null)){
} else {
var key_11787 = temp__5724__auto___11786;
(jsprops.key = key_11787);
}
...
var temp__5724__auto___11788 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___11788 == null)){
} else {
var key_11789 = temp__5724__auto___11788;
(jsprops.key = key_11789);
}
...
var temp__5724__auto___11790 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___11790 == null)){
} else {
var key_11791 = temp__5724__auto___11790;
(jsprops.key = key_11791);
}
...
var G__11793 = n;
if(cljs.core._EQ_.call(null,"",G__11793)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__11793)){
return x;
} else {
...
var len__4736__auto___11796 = arguments.length;
var i__4737__auto___11797 = (0);
while(true){
if((i__4737__auto___11797 < len__4736__auto___11796)){
args__4742__auto__.push((arguments[i__4737__auto___11797]));

var G__11798 = (i__4737__auto___11797 + (1));
i__4737__auto___11797 = G__11798;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11794){
var G__11795 = cljs.core.first.call(null,seq11794);
var seq11794__$1 = cljs.core.next.call(null,seq11794);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11795,seq11794__$1);
}));
...
break;
default:
var G__11801 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__11801;
continue;
...
var ctx = ({});
var vec__11803 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__11803,(0),null);
var derefed = cljs.core.nth.call(null,vec__11803,(1),null);
...
var G__11806 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11806) {
case (0):
