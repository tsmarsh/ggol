...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13387){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13388,G__13389,seq13387__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13393_SHARP_){
return (!((cljs.core.meta.call(null,p1__13393_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__13394__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13398){var _e__13030__auto__ = e13398;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e13400){var _e__13030__auto__ = e13400;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13402 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13403 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13403);

try{var map__13404 = opts;
...
var markup_db = cljs.core.get.call(null,map__13404__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13402);
}});
...
var temp__5718__auto___13409 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___13409)){
var managed_print_level_13410 = temp__5718__auto___13409;
var _STAR_print_level_STAR__orig_val__13407_13411 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13408_13412 = managed_print_level_13410;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13408_13412);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__13406_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__13406_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13407_13411);
}} else {
job_fn.call(null);
}
