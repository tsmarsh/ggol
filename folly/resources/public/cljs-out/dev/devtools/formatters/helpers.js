...
var G__13361 = devtools.prefs.pref.call(null,v);
v = G__13361;
continue;
} else {
return v;
...
}catch (e13364){var _e__13030__auto__ = e13364;
return false;
}})();
...
}catch (e13368){var _e__13030__auto__ = e13368;
return false;
}})();
...
}catch (e13370){var _e__13030__auto__ = e13370;
return false;
}}
}
});
...
var vec__13372 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13372,(0),null);
var name = cljs.core.nth.call(null,vec__13372,(1),null);
...
return cljs.core.some.call(null,(function (p1__13375_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13375_SHARP_);
}),template);
});
