...
var G__11285 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11285,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11285;
}
}));
...
var len__4736__auto___11290 = arguments.length;
var i__4737__auto___11291 = (0);
while(true){
if((i__4737__auto___11291 < len__4736__auto___11290)){
args__4742__auto__.push((arguments[i__4737__auto___11291]));

var G__11292 = (i__4737__auto___11291 + (1));
i__4737__auto___11291 = G__11292;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11287){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11288,G__11289,seq11287__$2);
}));
...
var line = cljs.core.get.call(null,map__11294__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11294__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11293_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11293_SHARP_));
...
var temp__5720__auto___11296 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11296)){
var message_11297 = temp__5720__auto___11296;
cljs.core.println.call(null,message_11297);
} else {
}
...
var temp__5720__auto___11298 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11298)){
var message_11299 = temp__5720__auto___11298;
cljs.core.println.call(null,message_11299);
} else {
}
...
var output_dir__$1 = (function (){var G__11300 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11300,"/"].join('');
} else {
return G__11300;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11302 = exception.stack;
var G__11302__$1 = (((G__11302 == null))?null:clojure.string.split_lines.call(null,G__11302));
var G__11302__$2 = (((G__11302__$1 == null))?null:cljs.core.get.call(null,G__11302__$1,depth));
if((G__11302__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11302__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11303 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11303,(0),null);
var column = cljs.core.nth.call(null,vec__11303,(1),null);
var vec__11306 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11306,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11306,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11306,(2),null);
...
var m__$1 = (function (){var G__11309 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__11309__$1 = (((G__11309 instanceof cljs.core.Keyword))?G__11309.fqn:null);
switch (G__11309__$1) {
case "fail":
...
var G__11313 = (function (){var G__11312 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11312);
} else {
return G__11312;
}
})();
...
return cljs.core.vary_meta.call(null,G__11314,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11318 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11318,(0),null);
var types = vec__11318;
...
return cljs.core.map.call(null,(function (p__11321){
var vec__11322 = p__11321;
var ns = cljs.core.nth.call(null,vec__11322,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11322,(1),null);
return (function (){
...
var G__11325 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11325__$1 = (((G__11325 instanceof cljs.core.Keyword))?G__11325.fqn:null);
switch (G__11325__$1) {
case "async":
...
var seq__11326 = cljs.core.seq.call(null,vars__$1);
var chunk__11327 = null;
var count__11328 = (0);
var i__11329 = (0);
while(true){
if((i__11329 < count__11328)){
var v = cljs.core._nth.call(null,chunk__11327,i__11329);
var temp__5720__auto___11331 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11331)){
var t_11332 = temp__5720__auto___11331;
each_fixture_fn.call(null,((function (seq__11326,chunk__11327,count__11328,i__11329,t_11332,temp__5720__auto___11331,v,each_fixture_fn,G__11325,G__11325__$1,env,once_fixtures,each_fixtures,vec__11322,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11332)));
});})(seq__11326,chunk__11327,count__11328,i__11329,t_11332,temp__5720__auto___11331,v,each_fixture_fn,G__11325,G__11325__$1,env,once_fixtures,each_fixtures,vec__11322,ns,vars__$1))
);
} else {
}


var G__11333 = seq__11326;
var G__11334 = chunk__11327;
var G__11335 = count__11328;
var G__11336 = (i__11329 + (1));
seq__11326 = G__11333;
chunk__11327 = G__11334;
count__11328 = G__11335;
i__11329 = G__11336;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11326);
if(temp__5720__auto__){
var seq__11326__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11326__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11326__$1);
var G__11337 = cljs.core.chunk_rest.call(null,seq__11326__$1);
var G__11338 = c__4556__auto__;
var G__11339 = cljs.core.count.call(null,c__4556__auto__);
var G__11340 = (0);
seq__11326 = G__11337;
chunk__11327 = G__11338;
count__11328 = G__11339;
i__11329 = G__11340;
continue;
} else {
var v = cljs.core.first.call(null,seq__11326__$1);
var temp__5720__auto___11341__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11341__$1)){
var t_11342 = temp__5720__auto___11341__$1;
each_fixture_fn.call(null,((function (seq__11326,chunk__11327,count__11328,i__11329,t_11342,temp__5720__auto___11341__$1,v,seq__11326__$1,temp__5720__auto__,each_fixture_fn,G__11325,G__11325__$1,env,once_fixtures,each_fixtures,vec__11322,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11342)));
});})(seq__11326,chunk__11327,count__11328,i__11329,t_11342,temp__5720__auto___11341__$1,v,seq__11326__$1,temp__5720__auto__,each_fixture_fn,G__11325,G__11325__$1,env,once_fixtures,each_fixtures,vec__11322,ns,vars__$1))
);
} else {
}


var G__11343 = cljs.core.next.call(null,seq__11326__$1);
var G__11344 = null;
var G__11345 = (0);
var G__11346 = (0);
seq__11326 = G__11343;
chunk__11327 = G__11344;
count__11328 = G__11345;
i__11329 = G__11346;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11325__$1)].join('')));
