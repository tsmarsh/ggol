...
return cljs.core.map.call(null,(function (p1__11940_SHARP_){
return html_coll.item(p1__11940_SHARP_);
...
return cljs.core.some.call(null,(function (p1__11941_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__11941_SHARP_);
...
var ctx_11942 = cvs.getContext("2d");
(ctx_11942.fillStyle = color);

ctx_11942.fillRect((0),(0),size,size);
